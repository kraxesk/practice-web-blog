/*!-----------------------------------------------------------------
    Name: Web-blog - Game Portal / Store HTML Template
    Version: 1.4.0
    Author: nK
    Website: https://nkdev.info/
    Purchase: https://themeforest.net/item/Web-blog-portal-store-html-gaming-template/17704593?ref=_nK
...
-------------------------------------------------------------------*/
var Web-blog = function () {
    function Web-blog() {
        _classCallCheck(this, Web-blog);

        this.options = _options.options;
    }

    _createClass(Web-blog, [{
        key: 'init',
        value: function init() {
            // prt:sc:dm
